...
public class MainActivity1 extends Activity {
    ...
    private class Title extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog.setTitle("Please Wait Retrieving Title...");
    ...
    private class Description extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(MainActivity1.this);
            mProgressDialog.setTitle("Please Wait Downloading Description...");
            mProgressDialog.setMessage("Loading...");
            mProgressDialog.setIndeterminate(false);
            mProgressDialog.show();
        }
    ...
    private class Logo extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(MainActivity1.this);
            mProgressDialog.setTitle("Please Wait Downloading Logo...");
            mProgressDialog.setMessage("Loading...");
            mProgressDialog.setIndeterminate(false);
            mProgressDialog.show();
        }
